    ...
    >
      <div className="container">
        ...
        <div className="text-center" style={{marginTop:"5rem"}}>
            ...
            <button onClick={onClickHandler} value="Send" className=" shadow-submit dark:shadow-submit-dark rounded-sm bg-primary px-9 py-4 text-base font-medium text-white duration-300 hover:bg-primary/90">
                                {posts.length === numberOfPostsToShow ? "Show Less" : "Show More"}
            </button>
